...
//
//  SelectionFeedbacking.swift
//  ThreeDSStoreDemo
//
//  Created by Drew Pitchford on 12/1/17.
...
public protocol TapticFeedbackable {}

extension TapticFeedbackable {
    
    // MARK: - Feedback actions
    public func fireSelectionFeedback() {
