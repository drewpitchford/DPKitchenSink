...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DPKitchenSink",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface PopoverViewController (SWIFT_EXTENSION(DPKitchenSink)) <UITableViewDataSource, UITableViewDelegate>
...
@interface UIViewController (SWIFT_EXTENSION(DPKitchenSink)) <UIPopoverPresentationControllerDelegate>
